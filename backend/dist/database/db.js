...
exports.company_ddb_datasource = exports.platform_datasource = void 0;
require("reflect-metadata");
const typeorm_1 = require("typeorm");
// Platform _________________________________________________________
exports.platform_datasource = new typeorm_1.DataSource({
    type: "mysql",
...
exports.company_ddb_datasource = new typeorm_1.DataSource({
    type: "mysql",
    host: "cacheflow-db-cluster-dev.cluster-c37w0dj5gpef.us-east-1.rds.amazonaws.com",
    port: 3306,
    username: "clusteradmin",
